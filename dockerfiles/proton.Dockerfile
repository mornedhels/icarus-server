FROM steamcmd/steamcmd:ubuntu-24@sha256:5c317692e02a738ae9ebe0582a612405c697e20f56de6954069de2aea120c0bd AS builder

ARG GE_PROTON_VERSION="9-25"
...
FROM steamcmd/steamcmd:ubuntu-24@sha256:5c317692e02a738ae9ebe0582a612405c697e20f56de6954069de2aea120c0bd
...
# MISC
RUN mkdir -p /usr/local/etc /var/log/supervisor /var/run/icarus /usr/local/etc/supervisor/conf.d/ /opt/icarus /home/icarus/.steam/sdk32 /home/icarus/.steam/sdk64 \
    && groupadd -g "${PGID:-4711}" -o icarus \
    && useradd -g "${PGID:-4711}" -u "${PUID:-4711}" -o --create-home icarus \
    && ln -f /root/.steam/sdk32/steamclient.so /home/icarus/.steam/sdk32/steamclient.so \
    && ln -f /root/.steam/sdk64/steamclient.so /home/icarus/.steam/sdk64/steamclient.so \
...
COPY --chmod=755 ../scripts/default/* ../scripts/proton/* /usr/local/etc/icarus/
